...
```html
<ca2-action-sheet v-model="show" :actions="actions" @select="onSelect" />
```
...
```html
<ca2-action-sheet v-model="show" :actions="actions" description="Description" />
```
...
```html
<ca2-action-sheet v-model="show" title="Title">
