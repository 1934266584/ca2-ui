...
test('click-nav event', () => {
  ...
  const navItems = wrapper.findAll('.zv-ree-select__nav-item');
...
test('click-item event', () => {
  ...
  const items = wrapper.findAll('.zv-ree-select__item');
...
test('click disabled nav', () => {
  ...
  const items = wrapper.findAll('.zv-ree-select__nav-item');
  items.at(0).trigger('click');
