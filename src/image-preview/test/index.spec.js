...
test('render image', async () => {
  ...
  const swipe = wrapper.find('.ca2-swipe__track');
...
test('closeable prop', () => {
  ...
  wrapper.find('.ca2-image-preview__close-icon').trigger('click');
...
test('function call', done => {
  ...
  Vue.nextTick(() => {
    const wrapper = document.querySelector('.ca2-image-preview');
    const swipe = wrapper.querySelector('.ca2-swipe__track');
    triggerDrag(swipe, 0, 0);
...
test('double click', async done => {
  ...
  const swipe = instance.$el.querySelector('.ca2-swipe__track');
  triggerDrag(swipe, 0, 0);
  triggerDrag(swipe, 0, 0);
